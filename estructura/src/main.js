    ...
    <section id="solicitudes" class="view">
      ...
      <div class="request-layout"><article class="panel form-panel"><h3>Nueva solicitud</h3><p class="form-intro">Los campos con <em>*</em> son obligatorios.</p>
        <form id="request-form" novalidate>
          ...
          <div class="form-row"><label>Sector *<select name="sector" required><option value="">Seleccione</option><option value="tecnologia">Tecnología</option><option value="manufactura">Manufactura</option><option value="bpo">BPO</option><option value="otro">Otro</option></select></label><label>Cédula jurídica *<input name="cedulaJuridica" required pattern="^3-\d{3}-\d{6}$" placeholder="3-101-123456"></label></div>
